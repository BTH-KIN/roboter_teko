...
#Loading model
model = cv2.dnn.readNetFromTensorflow('/home/pi/workspace/camera/models/frozen_inference_graph.pb',
                                      '/home/pi/workspace/camera/models/ssd_mobilenet_v2_coco_2018_03_29.pbtxt')

#Loading image
#image = cv2.imread("/home/pi/workspace/camera/download.jpg")
